...
/**
 * Tests to verify the functionality of the IncreasingPriceStrategy Comparator
 */
public class IncreasingPriceStrategyTest {
     ...
     * If the comparator returns 1, the tests asserts that the price of first order was greater than the second.
     */
    @Test
